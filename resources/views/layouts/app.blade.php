            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        @if (isset($topMenu))
                            @foreach ($topMenu as $menuPoint)
                                @if (isset($menuPoint['dropdown']))
                                    <li class="dropdown">
                                    ...
                                    @else
                                    <li><a href="{{ isset($menuPoint['routeName'])?  route($menuPoint['routeName']) : $menuPoint['href']}}">{{$menuPoint['text']}}</a></li>
                                @endif
                            @endforeach
                        @endif
                    </ul>
